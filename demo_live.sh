...
clear
printf "${B}  SLIPPAY ZK  ${R}${D}· confidential identity + bounded autonomy · Stellar mainnet${R}\n"
printf "${D}  ─────────────────────────────────────────────────────────────${R}\n"
pause 2
...
sub "github.com/Galmanus/slippay-zk · unaudited, demo keys"
printf "\n"
